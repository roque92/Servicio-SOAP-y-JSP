 ...
 * 
 */
@WebServiceClient(name = "Servicio", targetNamespace = "http://WebService/", wsdlLocation = "http://localhost:8080/ServicioWebCRUD/Servicio?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://WebService/", "Servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ServicioWebCRUD/Servicio?wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://WebService/", "ServicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService/", "ServicioPort"), Servicio.class, features);
    }
